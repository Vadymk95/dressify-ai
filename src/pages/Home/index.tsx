...
export const Home: FC = () => {
    ...
    return (
        <div className="flex flex-col items-center w-full animate-fadeInUp">
            ...
            <section className="w-full first-gradient text-amber-50 py-16 px-6 text-center rounded-b-3xl shadow-md">
            ...
            <section className="mt-12 px-6 max-w-4xl text-center">
            ...
            <section className="mt-12 first-gradient py-12 px-6 rounded-2xl shadow-xl text-center text-amber-50">
