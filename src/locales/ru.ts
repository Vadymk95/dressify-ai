        ...
        translation: {
            Components: {
                ...
                Features: {
                    ...
                    OutfitRequestPanel: {
                        title: 'Подбор образа',
                        description:
                            'Выберите тип образа, который вы хотите получить',
                        generating: 'Генерация...',
                        generateAi: 'Сгенерировать AI образ',
                        generateMoreAi: 'Сгенерировать еще',
                        ...
                        nextRequestsAt:
                            'Следующие запросы будут доступны в {{time}}',
                        loadingProfile: 'Загрузка профиля...',
                        loadingWeather: 'Загрузка погоды...',
                        verifyEmailNote:
                            'Для использования этой функции подтвердите email',
                        errors: {
                            freePlanLimit:
                                'Эта функция доступна только для премиум пользователей',
                            requestLimitReached:
                                'Достигнут лимит запросов на сегодня',
                            noEventType: 'Выберите тип события',
                            noGender:
                                'Выберите мужской или женский пол в настройках профиля',
                            emailNotVerified:
                                'Для использования этой функции подтвердите email',
                            missingData:
                                'Заполните необходимые данные в профиле',
                            invalidEventType:
                                'Выберите одно из доступных событий: встреча с друзьями, работа в офисе, свидание или шоппинг',
                            invalidGender: 'Выберите мужской или женский пол',
                            noLocation:
                                'Укажите местоположение или используйте ручной режим погоды',
                            noOutfitFound: 'Не удалось найти подходящий образ',
                            noWeather:
                                'Выберите погоду (текущую или на завтра)',
                            missingBasicInfo:
                                'Заполните базовые характеристики (пол, рост, вес, возраст)',
                            generic: 'Произошла ошибка. Попробуйте позже'
                        },
                        tooltip: {
                            title: 'Для создания образа необходимо:',
                            requirements: {
                                weather:
                                    '• Погода (текущая или на завтра) (или настройте вручную)',
                                basicInfo: '• Базовые характеристики:',
                                gender: '  - Пол',
                                height: '  - Рост',
                                weight: '  - Вес',
                                age: '  - Возраст',
            ...
            Pages: {
                ...
                Pricing: {
                    ...
                    plans: {
                        free: {
                            ...
                            feature4: 'Только 2 пола (мужской/женский)',
                            feature5: '4 базовых типа мероприятий',
                            cta: 'Бесплатно'
                        },
                        standard: {
                            title: 'Стандарт',
                            ...
                            feature5: 'Все типы мероприятий и 3 варианта пола',
                            cta: 'Выбрать план',
                ...
                WhatToWear: {
                    ...
                    minimalisticView: 'Минималистичный вид',
                ...
                Wardrobe: {
                    ...
                    saveChangesDescription:
                        'Вы хотите использовать гардероб для подбора образов?',
                    errors: {
                        maxLength:
