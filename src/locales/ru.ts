            ...
            Components: {
                ...
                Features: {
                    ...
                    OutfitRequestPanel: {
                        ...
                        errors: {
                            generic: 'Произошла ошибка при создании образа',
                            noEventType: 'Выберите тип события',
                            noLocation: 'Укажите ваше местоположение',
                            noGender: 'Укажите ваш пол',
                            freePlanLimit:
                                'Создание персональных образов недоступно на бесплатном тарифе',
                            requestLimitReached:
                                'Достигнут дневной лимит запросов. Попробуйте завтра или обновите тариф.'
                        }
                    }
                },
                Layout: {
